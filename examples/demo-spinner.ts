// Demo spinner component - shows how to create an animated spinner
// This is a demo component with internal loops - not for use in src/

import { TerminalRegion } from '../src/region';
import type { SpinnerOptions } from '../src/types';
