...
describe('Style Component', () => {
  ...
  describe('basic styling', () => {
    it('should apply color', () => {
      const component = style({ color: 'red' }, 'Hello');
    ...
    it('should apply backgroundColor', () => {
      const component = style({ backgroundColor: 'blue' }, 'Hello');
      const result = component({
        availableWidth: 80,
        region: region,
        columnIndex: 0,
    ...
    it('should apply bold', () => {
      const component = style({ bold: true }, 'Hello');
      const result = component({
        availableWidth: 80,
        region: region,
        columnIndex: 0,
  ...
  describe('overflow handling', () => {
    it('should truncate with ellipsis-end', () => {
      const component = style({ overflow: 'ellipsis-end' }, 'This is a very long text');
      const result = component({
        availableWidth: 10,
        region: region,
        columnIndex: 0,
    ...
    it('should truncate with ellipsis-start', () => {
      const component = style({ overflow: 'ellipsis-start' }, 'This is a very long text');
      const result = component({
        availableWidth: 10,
        region: region,
        columnIndex: 0,
    ...
    it('should wrap text', () => {
      const component = style({ overflow: 'wrap' }, 'This is a very long text that should wrap');
      const result = component({
        availableWidth: 10,
        region: region,
        columnIndex: 0,
  ...
  describe('when condition', () => {
    it('should return null when condition is false', () => {
      const component = style({ when: () => false }, 'Hello');
      const result = component({
        availableWidth: 80,
        region: region,
        columnIndex: 0,
    ...
    it('should return content when condition is true', () => {
      const component = style({ when: (ctx) => ctx.availableWidth > 50 }, 'Hello');
      const result = component({
        availableWidth: 80,
        region: region,
        columnIndex: 0,
  ...
  describe('multi-line content', () => {
    it('should apply styling to each line', () => {
      const component = style({ color: 'red' }, ['Line 1', 'Line 2']);
      const result = component({
        availableWidth: 80,
        region: region,
        columnIndex: 0,
